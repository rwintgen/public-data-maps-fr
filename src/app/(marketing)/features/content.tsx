...
const SECTION_ICONS = [
  ...
  <svg key="6" className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M13.19 8.688a4.5 4.5 0 011.242 7.244l-4.5 4.5a4.5 4.5 0 01-6.364-6.364l1.757-1.757m13.35-.622l1.757-1.757a4.5 4.5 0 00-6.364-6.364l-4.5 4.5a4.5 4.5 0 001.242 7.244" /></svg>,
]
          ...
          {t.features.sections.map((section, i) => (
            ...
            >
              ...
              <div className="flex-1 w-full lg:max-w-lg">
                <div className="rounded-xl border border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-white/[0.02] aspect-[4/3] flex items-center justify-center">
                  <div className="text-center">
                    <div className="w-12 h-12 rounded-lg bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-400 dark:text-gray-600 mx-auto mb-3">
                      {SECTION_ICONS[i]}
                    </div>
                    <p className="text-[13px] text-gray-400 dark:text-gray-600">{t.features.screenshotAlt}</p>
                  </div>
                </div>
              </div>
            </div>
